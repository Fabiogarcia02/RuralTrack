        ...
        import { Database, Truck, Sprout, Plus, X, Trash2, CheckCircle2, Syringe } from 'lucide-react';
        ...
        return (
            ...
            <header className="inventario-header">
                ...
                <p>Gestão centralizada de insumos, máquinas e saúde animal.</p>
                </div>
            ...
            {showModal && (
                ...
                <div className="modal-content">
                    ...
                    <h2>
                        ...
                        activeTab === 'medicamentos' ? 'Novo Medicamento/Vacina' : 'Novo Lote de Grãos'}
                    </h2>
                    ...
                    <div className="form-grid">
                        ...
                        <input required placeholder="Digite o nome..." value={formData.nome} onChange={e => setFormData({...formData, nome: e.target.value})} />
                        </div>
                        ...
                        <select value={formData.unidade} onChange={e => setFormData({...formData, unidade: e.target.value})}>
                            {activeTab === 'graos' && <><option value="t">Toneladas</option><option value="sc">Sacas</option></>}
                            {activeTab === 'maquinas' && <option value="un">Unidades</option>}
                            {activeTab === 'plantio' && <><option value="ha">Hectares</option><option value="m2">Metros²</option></>}
                            {activeTab === 'medicamentos' && <><option value="frascos">Frascos</option><option value="ml">ML</option><option value="doses">Doses</option></>}
                        </select>
                        </div>
                        ...
                        <input placeholder="..." value={formData.extra} onChange={e => setFormData({...formData, extra: e.target.value})} />
                        </div>
                    </div>
